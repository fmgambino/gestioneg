            ...
            <form action="<?php echo current_url(); ?>" id="formConfigurar" method="post" class="form-horizontal">
                <div class="widget-content nopadding tab-content">
                    ...
                    <div id="home" class="tab-pane fade in active">
                        ...
                        <div class="control-group">
                            <label for="control_datatable" class="control-label">Visualización en DataTables</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="os_notification" id="os_notification">
                                    ...
                                    <option value="tecnico" <?= $configuration['os_notification'] == 'tecnico' ? 'selected' : ''; ?>>Solo Técnico</option>
                                    <option value="emitente" <?= $configuration['os_notification'] == 'emitente' ? 'selected' : ''; ?>>Solo Emisor</option>
                                    <option value="nenhum" <?= $configuration['os_notification'] == 'nenhum' ? 'selected' : ''; ?>>No Notificar</option>
                                </select>
                                <span class="help-inline">Seleccione la opción de notificación por correo electrónico en el registro de las OS</span>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="span3">
                                ...
                                <select class="span12" name="notifica_whats_select" id="notifica_whats_select" value="">
                                    ...
                                    <option value="{TELEFONE_EMITENTE}">Telefone empresa</option>
                                    ...
                                    <option value="{DATA_GARANTIA}">Detalle Garantia</option>
                                </select>
                            </div>
                            <span6 class="span10">
                        ...
                        <div class="control-group">
                            ...
                            <div class="span8">
                                ...
                                <div class="span10" style="margin-left: 3em;">
                                    ...
                                    <label> <input <?= @in_array("Aguardando Piezas/Repuestos", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Aguardando Piezas/Repuestos"> <span class="lbl"> Aguardando Piezas/Repuestos</span> </label>
...
<div id="modal-confirmaratualiza" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/clientes/excluir" method="post">
        <div class="modal-header">
            ...
            <h5 id="myModalLabel">Atualización des Sistema</h5>
        </div>
...
<div id="modal-confirmabanco" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/clientes/excluir" method="post">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h5 id="myModalLabel">Atualización del Sistema</h5>
        </div>
        <div class="modal-body">
            ...
            <h7 style="text-align: left">¡Recomendamos hacer una copia de seguridad antes de continuar!
                <a target="_blank" title="Hacer Bakup" class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/Sgtos/backup">Hacer Backup</a>
            </h7>
        </div>
        <div class="modal-footer" style="display:flex;justify-content: center">
          <button class="button btn btn-mini btn-danger" data-dismiss="modal" aria-hidden="true"><span class="button__icon"><i class='bx bx-x' ></i></span> <span class="button__text2">Cancelar</span></button>

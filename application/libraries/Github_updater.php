...
class Github_updater
{
    ...
    public function update()
    {
        ...
        if ($hash !== $this->ci->config->item('current_commit')) {
            ...
            if ($dir = $this->_get_and_extract($hash)) {
                ...
                // Update the Sgtos version in the config filename
    ...
    */
    ...
    /**
    * Get Sgtos current version.
    *
    * @return string Sgtos current version.
    */
    private function getCurrentVersion()
    {
        ...
        if (!$version) {
            throw new Exception('Error getting Sgtos version from GitHub!');
        }

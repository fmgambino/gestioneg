        ...
        <form id="form-gerar-cobranca" name="cobranca" method="post" action="<?php echo base_url() . 'index.php/cobrancas/adicionar'; ?>">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" >Elige el método de pago</h4>
                </div>
                <div class="modal-body">
                    <div id="forma-pag" class="">
                        <div class="form-group">
                            ...
                            <label for="gateway_de_pagamento">Plataformas de Pago: </label>
                            <select id="gateway_de_pagamento" class="form-control span12" name="gateway_de_pagamento" required>
                                <option value="" selected>Elegir método de pago</option>
                            ...
                            <label id="label_forma_pagamento" for="forma_pagamento" hidden>Forma de Pago: </label>
                ...
                <div class="modal-footer">
                    <div>
                        ...
                        <span class="button__icon"><i class='bx bx-qr'></i></span><span class="button__text">Generar Pago On-Line</span></i></button>
                    </div>
                </div>
            </div>
        </form>

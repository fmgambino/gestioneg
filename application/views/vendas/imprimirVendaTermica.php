...
<head>
    <title>Map_Ventas_<?php echo $result->idVendas ?>_<?php echo $result->nomeCliente ?></title>
    <meta charset="UTF-8" />
                        ...
                        <table class="table">
                            <tbody>
                                <?php if ($emitente == null) { ?>
                                    <tr>
                                        <td colspan="4" class="alert">Necesita configurar los datos del Cliente. >>><a href="<?php echo base_url(); ?>index.php/Sgtos/emitente">Configurar</a>
                                            <<<< /td>
                                    </tr> <?php
                                } else { ?> <tr>

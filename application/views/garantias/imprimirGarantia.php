                        ...
                        <table class="table table-condensed">
                            <tbody>
                                <?php if ($emitente == null) { ?>
                                    <tr>
                                        <td colspan="3" class="alert">Debe configurar los datos del emisor. >>><a href="<?php echo base_url(); ?>index.php/mapos/emitente">Configurar</a>
                                            <<<</td> </tr> <?php
                                } else { ?> <tr>
                                ...
                                <tr>
                                    <td style="width: 50%; padding-left: 0">
                                        <ul>
                                            <li>
                                                <span>
                                                    <h5 class="text-center">Términos de Garantía/h5>
                                                </span>
                                            </li>
                                        </ul>
                                    </td>

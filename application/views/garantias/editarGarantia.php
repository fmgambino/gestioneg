    ...
    <div class="span12">
        <div class="widget-box">
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <h5>Editar Término de Garantía</h5>
            </div>
            <div class="widget-content">

                <?php if ($custom_error) { ?>
                    <div class="span12 alert alert-danger" id="divInfo" style="padding: 1%;">Datos incompletos, revisa los campos con asterisco o si has seleccionado correctamente cliente y responsable.</div>
                <?php  } ?>
                ...
                <form action="<?php echo current_url(); ?>" method="post" id="formGarantia">
                    ...
                    <div class="span12">
                        <div class="span2">
                            <label for="dataGarantia">Fecha</label>
                        ...
                        <div class="span12" style="margin-left: 0">
                            <label for="textoGarantia">
                                <h4 class="text-center">Término de Garantía</h4>
                            </label>
                    ...
                    <div class="span12" style="padding: 1%; margin-left: 0">
                        <div class="span6 offset5" style="display:flex;justify-content: center">
                            ...
                            <a href="<?php echo base_url() ?>index.php/garantias" id="" class="button btn btn-mini btn-warning"><span class="button__icon"><i class="bx bx-undo"></i></span> <span class="button__text2">Volver</span></a>
                        </div>
                    </div>
                </form>
                .

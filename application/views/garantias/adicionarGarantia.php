    ...
    <div class="span12">
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>Registrar Términos de Garantía</h5>
            </div>
            <div class="widget-content">

                <?php if ($custom_error == true) { ?>
                    <div class="span12 alert alert-danger" id="divInfo" style="padding: 1%;">Datos incompletos, verifique los campos com asterisco.</div>
                <?php
                } ?>
                <form action="<?php echo current_url(); ?>" method="post" id="formGarantia">
                    <div class="span12">
                        <div class="span2">
                            <label for="dataGarantia">Fecha<span class="required">*</span></label>
                            <input id="dataGarantia" class="span12 datepicker" type="text" name="dataGarantia" value="<?php echo date('d/m/Y'); ?>" disabled />
                        </div>
                        <div class="span3">
                            <label for="usuarios_id">Responsable<span class="required">*</span></label>
                            <input id="usuarios_id" class="span12" type="text" name="usuarios_id" value="<?php echo $this->session->userdata('nome_admin') ?>" disabled />
                        </div>
                        <div class="span7">
                            <label for="refGarantia">Ref Garantía<span class="required">*</span></label>
                        ...
                        <div class="span12" style="margin-left: 0">
                            <label for="textoGarantia">
                                <h4 class="text-center">Plazo de Garantía<span class="required">*</span></h4>
                            </label>

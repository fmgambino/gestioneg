...
<script type="text/javascript">
    ...
    $("#precoCompra").focusout(function () {
        if ($("#precoCompra").val() == '0.00' && $('#precoVenda').val() != '') {
            $('#errorAlert').text('No puede completar el monto de la compra y luego eliminar.').css("display", "inline").fadeOut(6000);
            $('#precoVenda').val('');
            $("#precoCompra").focus();
        } else {
   ...
   $("#margemLucro").keyup(function () {
        ...
        if ($("#precoCompra").val() == null || $("#precoCompra").val() == '') {
            $('#errorAlert').text('Ingrese el monto de la compra primero.').css("display", "inline").fadeOut(5000);
            $('#margemLucro').val('');
            $('#precoVenda').val('');
            $("#precoCompra").focus();
            ...
            $('#errorAlert').text('No se permiten números negativos.').css("display", "inline").fadeOut(5000);
            $('#margemLucro').val('');
            $('#precoVenda').val('');
        }
    });
    ...
    $('#precoVenda').focusout(function () {
        if (Number($('#precoVenda').val()) < Number($("#precoCompra").val())) {
            $('#errorAlert').text('El precio de venta no puede ser inferior al precio de compra.').css("display", "inline").fadeOut(6000);
            $('#precoVenda').val('');

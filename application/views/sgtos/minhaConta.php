    ...
    <div class="widget-box">
        ...
        <div class="widget-contentMC" style="margin: 20px 0 0;">
                        ...
                        <section>
                            <div class="profileMC">
                                <div class="profile-img">
                                    ...
                                    <a href="#modalImageUser" data-toggle="modal" role="button"><span class="tip-top img-user button__icon" title="Cambiar Foto"><i class='bx bxs-camera'></i></span></a>
                                </div>
                            </div>
                        </section>
                    </div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <ul class="site-stats">
                        <li class="bg_ls span12"><strong>Nombre:
                                <?= $usuario->nome ?></strong></li>
                        <li class="bg_lb span12" style="margin-left: 0"><strong>Teléfono/Whatsapp:
                                <?= $usuario->telefone ?></strong></li>
                        <li class="bg_lg span12" style="margin-left: 0"><strong>Email:
                                <?= $usuario->email ?></strong></li>
                        <li class="bg_lo span12" style="margin-left: 0"><strong>Nivel/Rol:
                                <?= $usuario->permissao; ?></strong></li>
                        <li class="bg_lh span12" style="margin-left: 0; border-bottom-left-radius: 9px;border-bottom-right-radius: 9px"><strong>El Acceso expira el:
        ...
        <div class="widget-content">
            <div class="row-fluid">
                <div class="span12" style="min-height: 260px">
                    <form id="formSenha" action="<?= site_url('Sgtos/alterarSenha'); ?>" method="post">
                        ...
                        <div class="span12" style="margin-left: 0">
                            ...
                            <button class="button btn btn-primary" style="max-width: 140px;text-align: center">
                              <span class="button__icon"><i class='bx bx-lock-alt'></i></span><span class="button__text2">Guardar</span></button>
                    </form>
                </div>
...
<div id="modalImageUser" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?= site_url('Sgtos/uploadUserImage'); ?>" id="formImageUser" enctype="multipart/form-data" method="post" class="form-horizontal">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 id="">Electronica Gambino - Actualizar Imágen de Usuario</h3>
        </div>
        <div class="modal-body">
            <div class="span12 alert alert-info">Seleccione una nueva imágen de usuario. Tamaño indicado (130 X 130).</div>

        ...
        <li class="card">
            <div class="grid-blak">
                <a href="<?= site_url('financeiro/lancamentos') ?>">
                    <div class="numbers N-tittle">Finanzas</div>
    ...
    <div class="Sspan12">
        ...
        <div class="new-statisc">
            <div class="widget-box-new widbox-blak" style="height:100%">
                <div>
                    <h5 class="cardHeader">Estadísticas del Sistema</h5>
                </div>

                <div class="new-bottons">
                    <a href="<?php echo base_url(); ?>index.php/clientes/adicionar" class="card tip-top" title="Nuevo Cliente/Proveedor">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/produtos/adicionar" class="card tip-top" title="Nuevo Producto">
                    ...
                    <a href="<?php echo base_url() ?>index.php/servicos/adicionar" class="card tip-top" title="Nuevo Servicio">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/os/adicionar" class="card tip-top" title="Nueva OS">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/garantias" class="card tip-top" title="Nueva Garantía">
                    ...
                    <a href="<?php echo base_url() ?>index.php/vendas/adicionar" class="card tip-top" title="Nueva Venta">
                    ...
                    <?php if ($estatisticas_financeiro != null) {
                        if ($estatisticas_financeiro->total_receita != null || $estatisticas_financeiro->total_despesa != null || $estatisticas_financeiro->total_receita_pendente != null || $estatisticas_financeiro->total_despesa_pendente != null) {  ?>
                            ...
                            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'rFinanceiro')) : ?>
                                ...
                                <a href="<?php echo base_url() ?>index.php/financeiro/lancamentos" class="card tip-top" title="Nueva receta">
                                    ...
                                    <div>
                                        ...
                                        <div class="cardName">Ingresos del día</div>
                                    </div>
                                </a>

                                <a href="<?php echo base_url() ?>index.php/financeiro/lancamentos" class="card tip-top" title="Nuevo Gasto">
                                    ...
                                    <div>
                                        ...
                                        <div class="cardName">Gastos del día</div>
                                    </div>
                                </a>
                            <?php endif ?>
            ...
            <div class="new-balance">
                <div class="widget-box0">
                    <div class="widget-title2">
                        <h5 class="cardHeader">Balance Anual</h5>
...
<script type="text/javascript">
    ...
    var myChart = new Chart(statusOS, {
        data: {
            labels: [
                'Ingreso total', 'Ingreso pendiente',
                'Pendiente en Caja', 'Gasto total',
...
<div class="span12A" style="margin-left: 0">
            ...
            <div class="widget-content">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="6">No hay productos/piezas con stock bajo.</td>
                            </tr>
                        <?php endif ?>
                    </tbody>
                </table>
        ...
        <div class="widget-content">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5">Sin OS abiertas.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
    ...
    <div class="widget-box0 widbox-blak">
        <div>
            <h5 class="cardHeader">Órdenes de trabajo en espera de repuestos/piezas</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered">
                <thead>
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5">Ninguna OS en espera de repuestos/piezas</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
        ...
        <div class="widget-content">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5">Ninguna OS en progreso.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
    ...
    <form action="<?php echo base_url() ?>index.php/produtos/atualizar_estoque" method="post" id="formEstoque">
        ...
        <div class="modal-body">
            <div class="control-group">
                <label for="estoqueAtual" class="control-label">Stock Actual</label>
                <div class="controls">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var srcCalendar = new FullCalendar.Calendar(srcCalendarEl, {
            ...
            events: {
                url: "<?= base_url() . "index.php/Sgtos/calendario"; ?>",
                method: 'GET',

...
<ul class="cardBox">
        ...
        <li class="card">
            <div class="grid-blak">
                <a href="<?= site_url('servicos') ?>">
                    <div class="numbers">Servicios</div>
    ...
    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) : ?>
        <li class="card">
            <div class="grid-blak">
                <a href="<?= site_url('os') ?>">
                    <div class="numbers N-tittle">Ordenes</div>
        ...
        <li class="card">
            <div class="grid-blak">
                <a href="<?= site_url('vendas/') ?>">
                    <div class="numbers N-tittle">Ventas</div>
        ...
        <li class="card">
            <div class="grid-blak">
                <a href="<?= site_url('financeiro/lancamentos') ?>">
                    <div class="numbers N-tittle">Lanzamientos</div>
    ...
    <div class="Sspan12">
                    ...
                    <div id='source-calendar'>
                        <form method="post">
                            <select style="padding-left: 30px" class="span12" name="statusOsGet" id="statusOsGet" value="">
                                ...
                                <option value="Aguardando Pieza">Aguardando Pieza</option>
        ...
        <div class="new-statisc">
            <div class="widget-box-new widbox-blak" style="height:100%">
                <div>
                    <h5 class="cardHeader">Estatísticas del Sistema</h5>
                </div>

                <div class="new-bottons">
                    <a href="<?php echo base_url(); ?>index.php/clientes/adicionar" class="card tip-top" title="Añadir Clientes y Proveedores">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/produtos/adicionar" class="card tip-top" title="Agregar Productos">
                    ...
                    <a href="<?php echo base_url() ?>index.php/servicos/adicionar" class="card tip-top" title="Agregar servicios">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/os/adicionar" class="card tip-top" title="Agregar OS">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/garantias" class="card tip-top" title="Agregar garantía">
                        <div><i class='bx bxs-receipt iconBx6'></i></div>
                        <div>
                            <div class="cardName2"><?= $this->db->count_all('garantias'); ?></div>
                            <div class="cardName">Garantías</div>
                        </div>
                    </a>

                    <a href="<?php echo base_url() ?>index.php/vendas/adicionar" class="card tip-top" title="Agregar Ventas">
                    ...
                    <?php if ($estatisticas_financeiro != null) {
                        if ($estatisticas_financeiro->total_receita != null || $estatisticas_financeiro->total_despesa != null || $estatisticas_financeiro->total_receita_pendente != null || $estatisticas_financeiro->total_despesa_pendente != null) {  ?>
                            ...
                            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'rFinanceiro')) : ?>
                                ...
                                <a href="<?php echo base_url() ?>index.php/financeiro/lancamentos" class="card tip-top" title="Agregar Ganancias">
                                    <div><i class='bx bxs-up-arrow-circle iconBx7'></i></div>
                                    <div>
                                        <div class="cardName1 cardName2">$ <?php echo number_format(($financeiro_mes_dia->$diaRec - $financeiro_mes_dia->$diaDes), 2, ',', '.'); ?></div>
                                        <div class="cardName">Ganancia del día</div>
                                    </div>
                                </a>

                                <a href="<?php echo base_url() ?>index.php/financeiro/lancamentos" class="card tip-top" title="Agregar gasto">
                                    <div><i class='bx bxs-down-arrow-circle iconBx8'></i></div>
                                    <div>
                                        <div class="cardName1 cardName2">$ <?php echo number_format(($financeiro_mes_dia->$diaDes ? $financeiro_mes_dia->$diaDes : 0), 2, ',', '.'); ?></div>
                                        <div class="cardName">Gasto del día</div>
                                    </div>
                                </a>
                            <?php endif ?>
            ...
            <div class="new-balance">
                <div class="widget-box0">
                    <div class="widget-title2">
                        <h5 class="cardHeader">Balance Mensual del Año</h5>
                ...
                <div class="widget-box-statist">
                    <h5 class="cardHeader">Estadísticas financieras</h5>
...
<div class="span12A" style="margin-left: 0">
    <div class="AAA">
        <div class="widget-box0 widbox-blak">
            <div>
                <h5 class="cardHeader">Productos con Stock Mínimo</h5>
            </div>
            <div class="widget-content">
                <table class="table table-bordered">
                    ...
                    <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eProduto')) : ?>
                                            ...
                                            <a href="#atualizar-estoque" role="button" data-toggle="modal" produto="<?= $p->idProdutos ?>" estoque="<?= $p->estoque ?>" class="btn-nwe5 tip-top" title="Actualizar Stock">
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="6">No hay productos de stock bajo.</td>
                            </tr>
                        <?php endif ?>
                    </tbody>
                </table>
    ...
    <div class="widget-box0 widbox-blak">
        <div>
            <h5 class="cardHeader">Órdenes de servicio abiertas</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered">
                <thead>
                ...
                <tbody>
                    <?php if ($ordens != null) : ?>
                        <?php foreach ($ordens as $o) : ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) : ?>
                                        <a href="<?= base_url() ?>index.php/os/visualizar/<?= $o->idOs ?>" class="btn-nwe tip-top" title="Ver">
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5">Sin OS abierta.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
    ...
    <div class="widget-box0 widbox-blak">
        <div>
            <h5 class="cardHeader">Órdenes de trabajo en espera de piezas</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered">
                <thead>
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="5">Ninguna OS en espera de piezas.</td>
                        </tr>
                    <?php endif ?>
                </tbody>
            </table>
    ...
    <div class="widget-box0 widbox-blak">
        <div>
            <h5 class="cardHeader">Órdenes de Trabajo en Progreso</h5>
        </div>
        <div class="widget-content">
            <table class="table table-bordered">
                <thead>
...
<div id="calendarModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        ...
        <h3 id="myModalLabel">Estado detallado de la OS</h3>
    </div>
    ...
    <div class="modal-footer">
        <?php
                                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) {
                                            echo '<a id="modalIdVisualizar" style="margin-right: 1%" href="" class="btn tip-top" title="Ver más detalles"><i class="fas fa-eye"></i></a>';
                                        }
                                        ...
                                        if ($this->permission->checkPermission($this->session->userdata('permissao'), 'dOs')) {
                                            echo '<a id="linkExcluir" href="#modal-excluir-os" role="button" data-toggle="modal" os="" class="btn btn-danger tip-top" title="Eliminar OS"><i class="fas fa-trash-alt"></i></a>  ';
                                        }
?>
    </div>
</div>
...
<div id="atualizar-estoque" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/produtos/atualizar_estoque" method="post" id="formEstoque">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h5 id="myModalLabel"><i class="fas fa-plus-square"></i> Actualizar Stock</h5>
        </div>
        <div class="modal-body">
            <div class="control-group">
                <label for="estoqueAtual" class="control-label">Stock Atual</label>
                <div class="controls">
            ...
            <div class="control-group">
                <label for="estoque" class="control-label">Agregar Productos<span class="required">*</span></label>
                <div class="controls">
        ...
        <div class="modal-footer" style="display:flex;justify-content: center">
            <button class="button btn btn-warning" data-dismiss="modal" aria-hidden="true"><span class="button__icon"><i class="bx bx-x"></i></span><span class="button__text2">Cancelar</span></button>
            <button class="button btn btn-primary"><span class="button__icon"><i class="bx bx-sync"></i></span><span class="button__text2">Actualizar</span></button>
        </div>
    </form>
</div>

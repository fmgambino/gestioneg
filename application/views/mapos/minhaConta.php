            ...
            <div class="row-fluid">
                <div class="span12">
                    <ul class="site-stats">
                        ...
                        <li class="bg_lb span12" style="margin-left: 0"><strong>Teléfono:
                                <?= $usuario->telefone ?></strong></li>
                        <li class="bg_lg span12" style="margin-left: 0"><strong>E-mail:
                                <?= $usuario->email ?></strong></li>
                        <li class="bg_lo span12" style="margin-left: 0"><strong>Nivel:
                    ...
                    <form id="formSenha" action="<?= site_url('mapos/alterarSenha'); ?>" method="post">
                        ...
                        <div class="span12" style="margin-left: 0">
                            ...
                            <button class="button btn btn-primary" style="max-width: 140px;text-align: center">
                              <span class="button__icon"><i class='bx bx-lock-alt'></i></span><span class="button__text2">Cambiar Contraseña</span></button>
                    </form>
                </div>

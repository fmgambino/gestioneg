            ...
            <form action="<?php echo current_url(); ?>" id="formConfigurar" method="post" class="form-horizontal">
                <div class="widget-content nopadding tab-content">
                    ...
                    <div id="menu3" class="tab-pane fade">
                        <div class="control-group">
                            <label for="os_notification" class="control-label">Notificación de OS</label>
                            <div class="controls">
                                <select name="os_notification" id="os_notification">
                                    <option value="todos">Notificar a Todos</option>
                                    <option value="cliente" <?= $configuration['os_notification'] == 'cliente' ? 'selected' : ''; ?>>Solo Cliente</option>
                        ...
                        <div class="control-group">
                            <label for="email_automatico" class="control-label">Enviar E-mail Automático</label>
                            <div class="controls">
                                ...
                                <span class="help-inline">Active o desactive la opción de envío automático de correo electrónico en el registro de la OS.</span>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="span3">
                                <label for="notifica_whats_select">Etiquetas para rellenar<span class="required"></span></label>
                                <select class="span12" name="notifica_whats_select" id="notifica_whats_select" value="">
                                    ...
                                    <option value="{DESCRI_PRODUTOS}">Descripción de productos</option>
                                    <option value="{EMITENTE}">Nombre del Cliente</option>
                                    <option value="{TELEFONE_EMITENTE}">Teléfono Cliente</option>
                                    ...
                                    <option value="{DATA_GARANTIA}">Fecha de Garantía</option>
                                </select>
                            </div>
                            <span6 class="span10">
                                Para negrita use: *palabra*
                                Para cursiva use: _palabra_
                                Para rayada use: ~palabra~
                                </span>
                        </div>
                        <div class="form-actions">
                            <div class="span8">
                    ...
                    <div id="menu1" class="tab-pane fade">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-inline">Activar o desactivar el control de gastos financieros, con fecha retroactiva.</span>
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="control_editos" class="control-label">Editar control de OS</label>
                            <div class="controls">
                                ...
                                <span class="help-inline">Habilitar o deshabilitar el permiso para cambiar o eliminar la OS facturada y/o cancelada.</span>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <label for="pix_key" class="control-label">API key para recibir pagos</label>
                            <div class="controls">
                                <input type="text" name="pix_key" value="<?= $configuration['pix_key'] ?>">
                                <span class="help-inline">API key para recibir pagos</span>
                            </div>
                        </div>
                        <div class="form-actions">
                            <div class="span8">
                    ...
                    <div id="menu2" class="tab-pane fade">
                        <div class="control-group">
                            <label for="control_estoque" class="control-label">Control de stock</label>
                            <div class="controls">
...
<div id="modal-confirmaratualiza" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/clientes/excluir" method="post">
        ...
        <div class="modal-body">
            ...
            <h7 style="text-align: left"><br>Haga una copia de seguridad de los siguientes archivos, ya que se eliminarán:</h7>
            <h7 style="text-align: left"><br>* ./activos/archivos adjuntos</h7>
            <h7 style="text-align: left"><br>* ./activos/archivos</h7>
        </div>
        <div class="modal-footer" style="display:flex;justify-content: center">
          ...
          <button id="update-mapos" type="button" class="button btn btn-warning"><span class="button__icon"><i class="bx bx-sync"></i></span><span class="button__text2">Actualizar</span></button>
        </div>
    </form>
</div>
<!-- Modal -->
<div id="modal-confirmabanco" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/clientes/excluir" method="post">
        ...
        <div class="modal-body">
            <h5 style="text-align: left">De verdad quieres actualizar la base de datos?</h5>
            <h7 style="text-align: left">Le recomendamos que haga una copia de seguridad antes de continuar.!
                <a target="_blank" title="Hacer copia de seguridad" class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/mapos/backup">Hacer copia de seguridad</a>
            </h7>
        </div>
        <div class="modal-footer" style="display:flex;justify-content: center">
          <button class="button btn btn-mini btn-danger" data-dismiss="modal" aria-hidden="true"><span class="button__icon"><i class='bx bx-x' ></i></span> <span class="button__text2">Cancelar</span></button>

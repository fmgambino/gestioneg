...
<div class="row-fluid" style="margin-top: 0">
    ...
    <span class="button__icon"><i class="bx bx-edit"></i> </span> <span class="button__text">Editar</span></a>';
                    ...
                    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eOs')) {
                        ...
                        if (!empty($zapnumber)) {
                            echo '<a title="Enviar Por WhatsApp" class="button btn btn-mini btn-success" id="enviarWhatsApp" target="_blank" href="https://wa.me/send?phone=54' . $zapnumber . '&text=' . $texto_de_notificacao . '">
        <span class="button__icon"><i class="bx bxl-whatsapp"></i></span> <span class="button__text">WhatsApp</span></a>';
                    ...
                    <a title="Enviar por E-mail" class="button btn btn-mini btn-warning" href="<?php echo site_url() ?>/os/enviar_email/<?php echo $result->idOs; ?>">
                        <span class="button__icon"><i class="bx bx-envelope"></i></span> <span class="button__text">Vía E-mail</span></a>
                    <?php if ($result->garantias_id) { ?> <a target="_blank" title="Imprimir Términos de Garantia" class="button btn btn-mini btn-inverse" href="<?php echo site_url() ?>/garantias/imprimir/<?php echo $result->garantias_id; ?>">
                                ...
                                <?php if ($emitente == null) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 18%; text-align: center"><b>N° OS:</b>
                                            ...
                                            <span>Emitido: <?php echo date('d/m/Y') ?></span>
                                        </td>
                                    </tr>
                                        ...
                                        <ul>
                                            <li>
                                                <span>
                                                    ...
                                                    <span>Contacto: <?php echo $result->celular_cliente ?></span>
                                            </li>
                                        </ul>
                                    </td>
                                    <td style="width: 50%; padding-left: 0">
                                        <ul>
                                            <li>
                                                ...
                                                <span>Contacto: <?php echo $result->telefone_usuario ?></span><br />
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                                    ...
                                                    if (!$anotacoes) {
                                                        echo '<tr><td colspan="2">Ninguna nota registrada.</td></tr>';
                                                    }
?>
                            </tbody>
                        </table>
    ...
    foreach ($produtos as $p) {
        ...
        echo '</tr>';
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>$ <?php echo number_format($totalProdutos, 2, ',', '.'); ?></strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            foreach ($servicos as $s) {
                                ...
                                echo '</tr>';
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>$ <?php echo number_format($totalServico, 2, ',', '.'); ?></strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
<div id="modal-anexo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        ...
        <h3 id="myModalLabel">Ver Adjunto</h3>
    </div>

...
<div class="widget-title" style="margin: -20px 0 0">
  ...
  <span class="button__icon"><i class='bx bx-plus-circle'></i></span><span class="button__text2">Agregar</span></a>
            ...
            <tbody>
                <?php
                    ...
                    foreach ($results as $r) {
                        ...
                        echo '<td>' . $situacao . '</td>';
                        echo '<td>
                                <a href="' . base_url() . 'index.php/permissoes/editar/' . $r->idPermissao . '" class="btn-nwe3" title="Editar Permisos/Roles"><i class="bx bx-edit"></i></a>
                                <a href="#modal-excluir" role="button" data-toggle="modal" permissao="' . $r->idPermissao . '" class="btn-nwe4" title="Deshabilitar Permiso"><i class="bx bx-notification-off" ></i></a>
                              </td>';
                        echo '</tr>';
                    } ?>
            </tbody>
...
<div id="modal-excluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/permissoes/desativar" method="post">
        <div class="modal-header">
            ...
            <h5 id="myModalLabel">Deshabilitar permiso</h5>
        </div>
        <div class="modal-body">
            <input type="hidden" id="idPermissao" name="id" value="" />
            <h5 style="text-align: center">Realmente quieres deshabilitar este permiso?</h5>
        </div>

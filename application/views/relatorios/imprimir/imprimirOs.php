...
<body style="background-color: transparent">
                        ...
                        <table width="100%" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th width="150" align="center" style="font-size: 12px">ESTADO</th>
                                    <th width="100" salign="center" style="font-size: 12px">FECHA</th>
                                    <th width="400" align="center" style="font-size: 12px">DESCRIPCIÓN</th>
                                    <th width="140" align="center" style="font-size: 12px">TOTAL PRODUCTOS</th>
    ...
    ?>
                                ...
                                <tr style="background-color: gainsboro;">
                                    <td colspan="5"></td>
                                    <td align="center"><small>$: <?= number_format($total_produtos, 2, ',', '.') ?></small></td>
                                    <td align="center"><small>$: <?= number_format($total_servicos, 2, ',', '.') ?></small></td>
                                    <td align="center"><small>$: <?= number_format($total_produtos + $total_servicos, 2, ',', '.') ?> </small></td>
                                    <td align="center"><small> </small></td>
                                    <td align="center"><small>$: <?= number_format($total_geral, 2, ',', '.') ?></small></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <h5 style="text-align: right; font-size: 0.8em; padding: 5px;">Fecha del Informe: <?php echo date('d/m/Y'); ?>
            </div>
        </div>
    </div>
</body>

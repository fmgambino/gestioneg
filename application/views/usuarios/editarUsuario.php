                ...
                <form action="<?php echo current_url(); ?>" id="formUsuario" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <i class="icon-exclamation-sign tip-top" title="Si no desea cambiar la contraseña, no rellene este campo."></i>
                        </div>
                    </div>
                        ...
                        <div class="span12">
                            <div class="span6 offset3" style="display:flex">
                                ...
                                <a href="<?php echo base_url() ?>index.php/usuarios" id="" class="button btn btn-mini btn-warning">
                                  <span class="button__icon"><i class="bx bx-undo"></i></span> <span class="button__text">Volver</span></a>
                            </div>
                        </div>
                    </div>

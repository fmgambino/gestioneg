            ...
            <div class="widget-content nopadding tab-content">
                ...
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        <li class="active" id="tabDetalhes"><a href="#tab1" data-toggle="tab">Detalles OS</a></li>
                        <li id="tabProdutos"><a href="#tab2" data-toggle="tab">Productos</a></li>
                        <li id="tabServicos"><a href="#tab3" data-toggle="tab">Servicios</a></li>
                        <li id="tabAnexos"><a href="#tab4" data-toggle="tab">Archivo Adjunto</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <div class="span12" style="padding: 1%; margin-left: 0">
                                    <label for="descricaoProduto">Descripción Producto/Servicio</label>
                                ...
                                <div class="span12" style="padding: 1%; margin-left: 0">
                                    <label for="laudoTecnico">Informe Técnico</label>
                                ...
                                <?php if ($this->session->userdata('cliente_anexa')) { ?>
                                    <div class="span12 well" style="padding: 1%; margin-left: 0" id="form-anexos">
                                        <form id="formAnexos" enctype="multipart/form-data" action="javascript:;" accept-charset="utf-8" s method="post">
                                            ...
                                            <div class="span2">
                                                <label for="">.</label>
                                                <button class="btn btn-success span12"><i class="fas fa-paperclip"></i> Adjuntar</button>
                                            </div>
                                        </form>
                                    </div>
                                <?php
...
<div id="modal-anexo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer">
        <button class="btn" data-dismiss="modal" aria-hidden="true">F</button>
...
<div id="modal-faturar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="formFaturar" action="<?php echo current_url() ?>" method="post">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 id="myModalLabel">Factura Venta</h3>
        </div>
        <div class="modal-body">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary">Factura</button>
        </div>
    </form>
</div>

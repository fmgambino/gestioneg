                            ...
                            <div class="card card-cad">
                                <div class="content">
                                    <div id="newlog">
                                        ...
                                        <div class="title01">
                                            <?= $configuration['app_theme'] == 'white' ? '<img src="' . base_url() . 'assets/img/">' : '<img src="' . base_url() . 'assets/img/logos/6.png">'; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <div class="main_input_box">
                                                ...
                                                <input class="" maxlength="18" size="18" name="senha" type="password" placeholder="Contraseña" value="" />
                                            </div>
                                        </div>
                                    </div>

                                    <button style="margin: 0" class="btn btn-info btn-large"> Acceder</button>
                                    <a href="<?= site_url('mine/cadastrar') ?>" class="btn btn-success btn-large">Registrarme</a>
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.result == true) {
                                window.location.href = "<?php echo base_url(); ?>index.php/mine/panel";
                            } else {
                                Swal.fire({
                                    position: 'center',
                                    icon: 'error',
                                    title: 'Los datos de acesso son incorrectos.\n Por favor intente nuevamente!',
                                    showConfirmButton: false,
                                    timer: 4000
                                })
                            }

            ...
            <div class="widget-content nopadding tab-content">
                ...
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        <li class="active" id="tabDetalhes"><a href="#tab1" data-toggle="tab">Detalles de OS</a></li>
                    </ul>
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%;">
                                        <div class="span12 alert alert-info">
                                            <h5 class="text-center">Rellena los siguientes campos detallando lo que necesitas. Los campos con asterisco son obligatorios.</h5>
                                        </div>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span12">
                                            <label for="descricaoProduto">Descripcion Producto/Servicio*</label>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span6 offset3" style="display:flex;justify-content: center">
                                            <button class="button btn btn-success" id="btnContinuar">
                                              <span class="button__icon"><i class='bx bx-plus-circle'></i></span><span class="button__text2">Registrar</span></button>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#formOs").validate({
            ...
            messages: {
                descricaoProduto: {
                    required: 'El Campo descrição da OS é obrigatório.'
                }
            },

...
<div class="quick-actions_homepage">
    <ul class="cardBox">
        <li class="card">
            ...
            <a href="<?php echo base_url() ?>index.php/mine/os">
                <div style="font-size: 1.2em" class="numbers">Ordenes de Servicio</div>
            </a>
        </li>
        ...
        <li class="card"> 
            ...
            <a href="<?php echo base_url() ?>index.php/mine/conta">
                <div style="font-size: 1.2em" class="numbers">Mi Cuenta</div>
            </a></li>
    </ul>
</div>
    ...
    <div class="widget-box">
        <div class="widget-title" style="margin: -20px 0 0">
          <span class="icon"><i class="fas fa-signal"></i></span>
            <h5>Últimas Ordenes de Servicio</h5>
        </div>
            ...
            <table id="tabela" class="table table-bordered">
                ...
                <tbody>
                    ...
                    if ($os != null) {
                        ...
                        echo '<tr><td colspan="3">No se encontraron órdenes de servicio.</td></tr>';
                    }

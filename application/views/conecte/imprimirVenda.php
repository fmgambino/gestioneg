            ...
            <div class="span12">
                ...
                <div class="invoice-content">
                            ...
                            <tbody>
                                ...
                                <?php if ($emitente == null) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 18%; text-align: center">#Venta: <span><?php echo $result->idVendas ?></span></br> </br> <span>Emisión: <?php echo date('d/m/Y'); ?></span></td>
                                    </tr>
                    ...
                    <div style="margin-top: 0; padding-top: 0">
                        ...
                        <?php if ($produtos != null) { ?>
                            ...
                            <table class="table table-bordered table-condensed" id="tblProdutos">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="2" style="text-align: right"><strong>Descuento: </strong></td>
                                        <td>
                                            <strong>
                        ...
                        <h4 style="text-align: right">Valor Total: $ <?php echo number_format($result->desconto != 0 && $result->valor_desconto != 0 ? $result->valor_desconto : $totalProdutos, 2, ',', '.'); ?></h4>

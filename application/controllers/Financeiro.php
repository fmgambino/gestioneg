...
class Financeiro extends MY_Controller
{
    ...
    public function adicionarReceita()
    {
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'aLancamento')) {
            $this->session->set_flashdata('error', 'No se le permite agregar lançamentos.');
            redirect(base_url());
        }
        ...
        if ($this->form_validation->run('receita') == false) {
            ...
            if ($this->financeiro_model->add('lancamentos', $data) == true) {
                $this->session->set_flashdata('success', 'Lançamento adicionado com Éxito');
        ...
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'aLancamento')) {
            ...
            if ($entrada == 0) {
                ...
                while ($loops <= $qtdparcelas_parc) {
                    ...
                    $data = [
                        'descricao' => $this->input->post('descricao_parc') . ' - Parcelamento de $' . $descricao_parc_valor .'  [' . $loops . '/' . $qtdparcelas_parc . ']',
                ...
                $desconto_entrada = "0";
                $data1 = [
                    'descricao' => $this->input->post('descricao_parc')  . ' - Entrada do parc. de $' . $descricao_parc_valor .' ',
                    'valor' => $entrada,
    ...
    public function adicionarDespesa()
    {
        ...
        if ($this->form_validation->run('despesa') == false) {
            ...
            if ($this->financeiro_model->add('lancamentos', $data) == true) {
                $this->session->set_flashdata('success', 'Despesa adicionada com Éxito');
    ...
    public function editar()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->financeiro_model->edit('lancamentos', $data, 'idLancamentos', $this->input->post('id')) == true) {
                $this->session->set_flashdata('success', 'lançamento editado com Éxito');

...
class Permissoes extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'cPermissao')) {
            $this->session->set_flashdata('error', 'Você não tem permissão para configurar as Persimos/Roles no sistema.');
            redirect(base_url());
        }

        $this->load->helper(['form', 'codegen_helper']);
        $this->load->model('permissoes_model');
        $this->data['menuConfiguracoes'] = 'Persimos/Roles';
    }
    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->permissoes_model->add('permissoes', $data) == true) {
                $this->session->set_flashdata('success', 'Permissão adicionada com Éxito');
    ...
    public function editar()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->permissoes_model->edit('permissoes', $data, 'idPermissao', $this->input->post('idPermissao')) == true) {
                $this->session->set_flashdata('success', 'Permissão editada com Éxito');
    ...
    public function desativar()
    {
        ...
        if ($this->permissoes_model->edit('permissoes', $data, 'idPermissao', $id)) {
            ...
            $this->session->set_flashdata('success', 'Permissão desativada com Éxito');
        } else {

...
class Relatorios extends MY_Controller
{
    ...
    public function clientes()
    {
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'rCliente')) {
            $this->session->set_flashdata('error', 'No tiene permiso para generar informes de clientes.');
            redirect(base_url());
        }
    ...
    public function produtos()
    {
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'rProduto')) {
            $this->session->set_flashdata('error', 'No está autorizado a generar informes de productos.');
            redirect(base_url());
        }
    ...
    public function clientesCustom()
    {
        ...
        $data['emitente'] = $this->Sgtos_model->getEmitente();
        $data['title'] = 'Informe de Cliente Personalizado';
    ...
    public function clientesRapid()
    {
        ...
        $data['emitente'] = $this->Sgtos_model->getEmitente();
        $data['title'] = 'Informe de Clientes';
        $data['topo'] = $this->load->view('relatorios/imprimir/imprimirTopo', $data, true);
    ...
    public function produtosRapid()
    {
        ...
        $data['emitente'] = $this->Sgtos_model->getEmitente();
        $data['title'] = 'Informes de Productos';
        $data['topo'] = $this->load->view('relatorios/imprimir/imprimirTopo', $data, true);
    ...
    public function produtosRapidMin()
    {
        ...
        $data['emitente'] = $this->Sgtos_model->getEmitente();
        $data['title'] = 'Informes de Productos Con Stock Mínimo';
        $data['topo'] = $this->load->view('relatorios/imprimir/imprimirTopo', $data, true);
    ...
    public function produtosCustom()
    {
        ...
        $data['emitente'] = $this->Sgtos_model->getEmitente();
        $data['title'] = 'Informe de Producto Personalizado';
        $data['topo'] = $this->load->view('relatorios/imprimir/imprimirTopo', $data, true);
    ...
    public function produtosEtiquetas()
    {
        ...
        try {
            if ($de <= $ate) {
                ...
                $this->session->set_flashdata('error', 'El Campo "<b>Desde</b>" no puede ser más grande que el Campo "<b>Hasta</b>"!');
                redirect('produtos');
            }
        } catch (Exception $e) {
    ...
    public function sku()
    {
        if (!($this->permission->checkPermission($this->session->userdata('permissao'), 'rVenda')
            ...
            $this->session->set_flashdata('error', 'No tiene permiso para generar un informe de SKU.');
            redirect(base_url());
        }
    ...
    public function servicos()
    {
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'rServico')) {
            $this->session->set_flashdata('error', 'No está autorizado a generar informes de servicio.');
            redirect(base_url());
        }
    ...
    public function servicosCustom()
    {
        ...
        $data['emitente'] = $this->Sgtos_model->getEmitente();
        $data['title'] = 'Informe de Servicios Personalizados';
        $data['topo'] = $this->load->view('relatorios/imprimir/imprimirTopo', $data, true);
    ...
    public function os()
    {
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'rOs')) {
            $this->session->set_flashdata('error', 'No tiene permiso para generar informes de OS');
            redirect(base_url());
        }
    ...
    public function osCustom()
    {
        ...
        $emitente = $this->Sgtos_model->getEmitente();
        $usuario = is_array($user) ? $user[0]->nome : $user;

        $data['title'] = 'Informes de OS - ' . $title;
        $data['os'] = $os;
        $data['total_produtos'] = $totalProdutos;
        $data['total_servicos'] = $totalServicos;
        $data['total_geral_desconto'] = $totalDesconto;
    ...
    public function financeiro()
    {
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'rFinanceiro')) {
            $this->session->set_flashdata('error', 'No está autorizado a generar informes financieros.');
            redirect(base_url());
        }
    ...
    {
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'rVenda')) {
            $this->session->set_flashdata('error', 'No está autorizado a generar informes de ventas.');
            redirect(base_url());
        }
    ...
    public function receitasBrutasRapid()
    {
        ...
        if (!$templatePath) {
            $this->session->set_flashdata('error', '¡Plantilla de informe no encontrada!');
